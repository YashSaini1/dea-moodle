...
$string['aria:deletecourse'] = 'Delete this course';
...
$string['list'] = 'List';
$string['sql_myoverview:myaddinstance'] = 'Add a new course overview block to SQL Dashboard';
$string['nocustomvalue'] = 'No {$a}';
$string['past'] = 'Past';
$string['pluginname'] = 'SQL Course overview';
...
$string['disabled_coaching_link'] = 'Link that will be displayed for the users, that doesn\'t have coaching';
$string['show'] = 'Restore to view';
$string['sortbytitle'] = 'Sort by course name';
$string['sortbysortorder'] = 'Sort by default';
$string['sortbylastaccessed'] = 'Sort by last accessed';
$string['sortbyshortname'] = 'Sort by short name';
$string['privacy:request:preference:set'] = 'The value of the setting \'{$a->name}\' was \'{$a->value}\'';
$string['specialcourse'] = 'Special course';
