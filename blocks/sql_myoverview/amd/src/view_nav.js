...
import * as View from 'block_sql_myoverview/view';
...
const updatePreferences = (filter, value) => {
    let type = null;
    if (filter === 'display') {
        type = 'block_sql_myoverview_user_view_preference';
    } else if (filter === 'sort') {
        type = 'block_sql_myoverview_user_sort_preference';
    } else if (filter === 'customfieldvalue') {
        type = 'block_sql_myoverview_user_grouping_customfieldvalue_preference';
    } else {
        type = 'block_sql_myoverview_user_grouping_preference';
    }
