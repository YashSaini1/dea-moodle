...
/* Checking if the request comes from the sql_comment block */
if (optional_param('component', false, PARAM_TEXT) == 'block_sql_comments') {
...
// initilising comment object
    ...
    $manager = new \block_sql_comments\sql_comment($args);
