...
require_once($CFG->customscripts."/question/bank/managecategories/sql_question_category_object.php");
...
$qcobject = new sql_question_category_object($pagevars['cpage'], $thispageurl,
...
if ($param->delete) {
    ...
    if ($questionstomove) {
        require_once($CFG->customscripts."/question/bank/managecategories/sql_question_move_form.php");
        $categorycontext = context::instance_by_id($category->contextid);
        $qcobject->moveform = new sql_question_move_form($thispageurl,
            ['contexts' => [$categorycontext], 'currentcat' => $param->delete, 'questionstomove' => $questionstomove]);
...
$template_data = $qbankaction->export_for_template($renderer);
unset($template_data['questionbankselect']);
echo $renderer->render_from_template('core_question/qbank_action_menu', $template_data);
