...
class frontend extends \core_availability\frontend {
    ...
    protected function get_javascript_strings() {
        return ['label_cm', 'label_completion'];
    }
    ...
    protected function get_javascript_init_params($course, \cm_info $cm = null,
        ...
        if ($cachekey !== $this->cachekey) {
            ...
            if ($previouscm) {
                $previous = (object)['id' => \availability_coaching_completion\condition::OPTION_PREVIOUS,
                        'name' => get_string('option_previous', 'availability_coaching_completion'),
                        'completiongradeitemnumber' => \availability_coaching_completion\condition::OPTION_PREVIOUS];
                array_unshift($cms, $previous);

                $previous_section = (object)['id' => \availability_coaching_completion\condition::OPTION_PREVIOUS_SECTION,
                        'name' => get_string('option_previous_section', 'availability_coaching_completion'),
                        'completiongradeitemnumber' => \availability_coaching_completion\condition::OPTION_PREVIOUS_SECTION];
                array_unshift($cms, $previous_section);
            }
            $this->cachekey = $cachekey;
            $this->cacheparams = [$cms];
        }
