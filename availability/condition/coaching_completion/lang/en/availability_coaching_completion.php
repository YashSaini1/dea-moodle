...
$string['error_inputted_percent'] = 'You must provide a percent value in range from 0 to 100.';
...
$string['option_previous_section'] = 'Previous Section must be completed';
...
$string['requires_previous_section_incomplete'] = 'The <strong>previous section</strong> is incomplete';
$string['requires_previous_section_complete'] = 'The <strong>previous section</strong> is marked complete';
...
$string['title'] = 'Extended Activity completion';
