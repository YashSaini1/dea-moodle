...
/**
 * List of Web Services for the qtype_pythonrunner plugin.
 *
 * @package    qtype
...
$functions = array(
    'qtype_pythonrunner_run_in_sandbox' => [
        'classname'   => 'qtype_pythonrunner\external\run_in_sandbox',
        'classpath'   => '',
        ...
        'capabilities' => 'qtype/pythonrunner:sandboxwsaccess',
