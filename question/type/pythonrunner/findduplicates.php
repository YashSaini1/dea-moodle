...
$PAGE->set_url('/question/type/pythonrunner/findduplicates.php', array('contextid' => $context->id));
...
$allquestionsmap = $bulktester->get_all_pythonrunner_questions_in_context($contextid);
