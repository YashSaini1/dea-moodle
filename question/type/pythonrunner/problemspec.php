...
/**
 * Script to return the spec for the currently-rendered pythonrunner question,
 ...
 * although in fact it searches all zip files in the current pythonrunner
...
$qids = $USER->pythonrunnerquestionids;
