...
$PAGE->set_url('/question/type/pythonrunner/prototypeusage.php');
...
if (!has_capability('moodle/question:editall', $coursecontext)) {
    ...
    $questions = $bulktester->get_all_pythonrunner_questions_in_context($coursecontextid);
    $prototypequestions = qtype_pythonrunner::get_all_prototypes($courseid);
    $prototypes = [];
    foreach ($prototypequestions as $prototype) {
        $prototypes[$prototype->pythonrunnertype] = $prototype;
    }
