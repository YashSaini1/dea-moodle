...
$PAGE->set_url('/question/type/pythonrunner/bulktestall.php',
        array('startfromcontextid' => $startfromcontextid));
$PAGE->set_context($context);
$title = pythonrunner_str('bulktesttitle', $context->get_context_name());
...
// Run the tests.
foreach ($bulktester->get_num_pythonrunner_questions_by_context() as $contextid => $numpythonrunnerquestions) {
    ...
    if (has_capability('moodle/question:editall', $context)) {
        echo $OUTPUT->heading(pythonrunner_str('bulktesttitle', $testcontext->get_context_name()));
        echo html_writer::tag('p', html_writer::link(
                new moodle_url('/question/type/pythonrunner/bulktestall.php',
                    array('startfromcontextid' => $testcontext->id)),
            pythonrunner_str('bulktestcontinuefromhere')));
