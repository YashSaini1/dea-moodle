 ...
 * wrapper.
 *
 * @module pythonrunner/userinterfacewrapper
...
// ace not used here, but this file require it
define(['jquery', 'qtype_sqlrunner/ace/ace'], function($) {
    /**
    ...
    InterfaceWrapper.prototype.loadUi = function(uiname, params) {
        var t = this,
            ...
            errPart2 = ' UI component. If this error persists, please report it to the forum on pythonrunner.org.nz';
        ...
        function setLoadFailMessage(langString, errorDiv) {
            require(['core/str'], function(str) {
                 ...
                 */
                var
                    s = str.get_string(langString, 'qtype_pythonrunner'),
                    fallback = str.get_string('ui_fallback', 'qtype_pythonrunner');
        ...
        if (this.uiname === '' || this.uiname === 'none' || sessionStorage.getItem('disableUis')) {
            ...
            this.isLoading = true;
            require(['qtype_sqlrunner/ui_' + this.uiname],
                function(ui) {
