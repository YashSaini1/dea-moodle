 ...
 *
 *****************************************************************************/
define("qtype_pythonrunner/userinterfacewrapper",["jquery","qtype_sqlrunner/ace/ace"],(function($){function InterfaceWrapper(uiname,textareaId){var h,params,t=this;this.GUTTER=14,this.MIN_WRAPPER_HEIGHT=50,this.DEFAULT_SYNC_INTERVAL_SECS=5,this.taId=textareaId,this.loadFailId=textareaId+"_loadfailerr",this.textArea=$(document.getElementById(textareaId)),params=this.textArea.attr("data-params"),this.uiParams=params?JSON.parse(params):{},this.uiParams.lang=this.textArea.attr("data-lang"),this.readOnly=this.textArea.prop("readonly"),this.isLoading=!1,this.loadFailed=!1,this.retries=0,h=Math.max(parseInt(this.textArea.css("height")),this.MIN_WRAPPER_HEIGHT),this.wrapperNode=$("<div id='"+this.taId+"_wrapper' class='ui_wrapper'></div>"),this.textArea.after(this.wrapperNode),this.wrapperNode.hide(),this.wrapperNode.css({resize:"vertical",overflow:"hidden",minHeight:h,width:"100%",border:"1px solid darkgrey"}),this.textArea.data("current-ui-wrapper",this),this.uiInstance=null,this.loadUi(uiname,this.uiParams),$(document).mousemove((function(){t.checkForResize()})),$(window).resize((function(){t.checkForResize()})),this.textArea.closest("form").submit((function(){null!==t.uiInstance&&t.uiInstance.sync()})),$(document.body).on("keydown",(function(e){77===e.keyCode&&e.ctrlKey&&e.altKey&&(null!==t.uiInstance||t.loadFailed?t.stop():t.restart())}))}return InterfaceWrapper.prototype.loadUi=function(uiname,params){var t=this;function syncIntervalSecsBase(){return params.hasOwnProperty("sync_interval_secs")?parseInt(params.sync_interval_secs):t.DEFAULT_SYNC_INTERVAL_SECS}if(this.isLoading)return this.retries+=1,void(this.retries>20?(alert("Failed to load "+uiname+" UI component. If this error persists, please report it to the forum on pythonrunner.org.nz"),this.retries=0,this.loading=0):setTimeout((function(){t.loadUi(uiname,params)}),200));this.retries=0,this.params=params,this.stop(),this.uiname=uiname,""===this.uiname||"none"===this.uiname||sessionStorage.getItem("disableUis")?this.uiInstance=null:(this.isLoading=!0,require(["qtype_sqlrunner/ui_"+this.uiname],(function(ui){var uiInstance,loadFailDiv,jqLoadFailDiv,h,w,uiInstancePrototype,langString,errorDiv;h=t.wrapperNode.innerHeight()-t.GUTTER,w=t.wrapperNode.innerWidth(),(uiInstance=new ui.Constructor(t.taId,w,h,params)).failed()?(t.loadFailed=!0,t.wrapperNode.hide(),uiInstance.destroy(),t.uiInstance=null,t.textArea.addClass("uiloadfailed"),loadFailDiv='<div id="'+t.loadFailId+'"class="uiloadfailed"></div>',(jqLoadFailDiv=$(loadFailDiv)).insertBefore(t.textArea),langString=uiInstance.failMessage(),errorDiv=jqLoadFailDiv,require(["core/str"],(function(str){var s=str.get_string(langString,"qtype_pythonrunner"),fallback=str.get_string("ui_fallback","qtype_pythonrunner");$.when(s,fallback).done((function(s,fallback){errorDiv.html(s+"<br>"+fallback)}))}))):(t.hLast=0,t.wLast=0,t.textArea.hide(),t.wrapperNode.show(),t.wrapperNode.append(uiInstance.getElement()),t.uiInstance=uiInstance,t.loadFailed=!1,t.checkForResize(),(uiInstancePrototype=Object.getPrototypeOf(uiInstance)).syncIntervalSecs=uiInstancePrototype.syncIntervalSecs||syncIntervalSecsBase,t.startSyncTimer(uiInstance)),t.isLoading=!1})))},InterfaceWrapper.prototype.startSyncTimer=function(uiInstance){var timeout=uiInstance.syncIntervalSecs();this.uiInstance.timer=timeout?setInterval((function(){uiInstance.sync()}),1e3*timeout):null},InterfaceWrapper.prototype.stopSyncTimer=function(uiInstance){uiInstance.timer&&clearTimeout(uiInstance.timer)},InterfaceWrapper.prototype.stop=function(){null!==this.uiInstance&&(this.stopSyncTimer(this.uiInstance),this.textArea.show(),this.uiInstance.hasFocus()&&(this.textArea.focus(),this.textArea[0].selectionStart=this.textArea[0].value.length),this.uiInstance.destroy(),this.uiInstance=null,this.wrapperNode.hide()),this.loadFailed=!1,this.textArea.removeClass("uiloadfailed"),$(document.getElementById(this.loadFailId)).remove()},InterfaceWrapper.prototype.restart=function(){null===this.uiInstance&&this.loadUi(this.uiname,this.params)},InterfaceWrapper.prototype.checkForResize=function(){var h,hAdjusted,w,wAdjusted,xLeft,maxWidth;this.uiInstance&&(h=this.wrapperNode.innerHeight(),w=this.wrapperNode.innerWidth(),h==this.hLast&&w==this.wLast||(xLeft=this.wrapperNode.offset().left,maxWidth=$(window).innerWidth()-xLeft-25,hAdjusted=h-this.GUTTER,wAdjusted=Math.min(maxWidth,w),this.uiInstance.resize(wAdjusted,hAdjusted),this.hLast=this.wrapperNode.innerHeight(),this.wLast=this.wrapperNode.innerWidth()))},{newUiWrapper:function(uiname,textareaId){return uiname?new InterfaceWrapper(uiname,textareaId):null},InterfaceWrapper:InterfaceWrapper}}));
