...
/**
 * Behat extensions for pythonrunner.
 *
...
class behat_pythonrunner extends behat_base {
    /**
    ...
    public function i_should_see_highlighted($expected) {
        $delxpath = "//div[contains(@class, 'pythonrunner-test-results')]//del[contains(text(), '{$expected}')]";
