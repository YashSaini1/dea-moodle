 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_pythonrunner_restore_testcase extends advanced_testcase {
    /**
    ...
    protected function load_question_data_by_name($name) {
        ...
        return array(
                $DB->get_record('question_python_options',
                        array('questionid' => $questionid), '*', MUST_EXIST),
                $DB->get_records('question_python_tests',
    ...
    public function test_restore() {
        ...
        $this->restore_backup($CFG->dirroot .
                '/question/type/pythonrunner/tests/fixtures/loadtesting_pseudocourse_backup.mbz');
    ...
    public function test_restore_from_v3_0_0() {
        ...
        $this->restore_backup($CFG->dirroot .
                '/question/type/pythonrunner/tests/fixtures/loadtesting_pseudocourse_backup_V3.0.0.mbz');
