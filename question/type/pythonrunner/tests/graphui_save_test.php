...
class qtype_pythonrunner_graphui_save_testcase extends qtype_pythonrunner_testcase {

    protected $qtype;

    protected function setUp(): void {
        $this->resetAfterTest(true);
        $this->qtype = new qtype_pythonrunner();
    }

    public function test_question_saving_graph_ui() {
        $this->setAdminUser();

        $questiondata = test_question_maker::get_question_data('pythonrunner');
        $questiondata->options->uiplugin = 'graph';
        $formdata = test_question_maker::get_question_form_data('pythonrunner');
        ...
        qtype_pythonrunner_edit_form::mock_submit((array)$formdata);

        $form = qtype_pythonrunner_test_helper::get_question_editing_form($cat, $questiondata);
