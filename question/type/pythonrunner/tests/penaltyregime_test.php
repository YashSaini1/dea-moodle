...
require_once($CFG->dirroot . '/question/type/pythonrunner/tests/helper.php');
...
class qtype_pythonrunner_penaltyregime_testcase extends qbehaviour_walkthrough_test_base {
    ...
    public function run_with_regime($regime, $numbadattempts, $expected) {
        $helper = new qtype_pythonrunner_test_helper();
        $q = $helper->make_pythonrunner_question_sqr(array('penaltyregime' => $regime));
