...
require_once($CFG->dirroot . '/question/type/pythonrunner/vendor/autoload.php');
require_once($CFG->dirroot . '/question/type/pythonrunner/classes/twigmacros.php');

/**
 * Unit tests for the pythonrunner question definition class.
 */
class qtype_pythonrunner_template_testcase extends qtype_pythonrunner_testcase {
