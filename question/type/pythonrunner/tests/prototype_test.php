...
/**
 * Unit tests for the pythonrunner question prototype capability
...
class qtype_pythonrunner_prototype_testcase extends qtype_pythonrunner_testcase {
...
EOTEMPLATE;
  ...
  <question type="pythonrunner">
    ...
    <generalfeedback format="html">
      <text>No feedback available for pythonrunner questions.</text>
    </generalfeedback>
    <defaultgrade>1</defaultgrade>
    <penalty>0.3333333</penalty>
    <hidden>0</hidden>
    <idnumber></idnumber>
    <pythonrunnertype>sqr_user_prototype</pythonrunnertype>
...
';
    ...
    private function make_sqr_user_type_prototype($fileattachmentreqd = false) {
        ...
        $q->prototypetype = 2;
        $q->pythonrunnertype = "sqr_user_prototype";
        ...
        $row = new qtype_pythonrunner_question();
