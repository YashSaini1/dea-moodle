 ...
 */
class qtype_pythonrunner_ui_parameters_testcase extends qtype_pythonrunner_testcase {

    // Test that the json specifier for the graph_ui class can be loaded.
    public function test_params() {
        $graphuiparams = new qtype_pythonrunner_ui_parameters('graph');
        ...
        $aceparams = new qtype_pythonrunner_ui_parameters('ace');
    ...
    public function test_plugin_list() {
        $plugins = qtype_pythonrunner_ui_plugins::get_instance();
