...
/**
 * Unit tests for the pythonrunner question type class.
...
require_once($CFG->dirroot . '/question/type/pythonrunner/edit_pythonrunner_form.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_pythonrunner_questiontype_testcase extends advanced_testcase {
    protected $qtype;
    ...
    public function test_name() {
        $this->assertEquals('pythonrunner', $this->qtype->name());
    }
