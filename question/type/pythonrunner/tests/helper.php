<?php
// This file is part of CodeRunner - http://pythonrunner.org.nz/
//
...
/**
 * Test helpers for the pythonrunner question type.
 *
 * @package    qtype
...
require_once($CFG->dirroot . '/question/type/pythonrunner/tests/test.php');

qtype_pythonrunner_testcase::setup_test_sandbox_configuration();
...
class qtype_pythonrunner_missing_question_type extends Exception {
}

/**
 * Test helper class for the pythonrunner question type.
 *
 */
class qtype_pythonrunner_test_helper extends question_test_helper {
    ...
    /**
     * Makes a pythonrunner python3 question asking for a sqr() function
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqr($extras = array()) {
        return $this->make_pythonrunner_question_sqr_subtype('python3', $extras);
    }

    public function get_pythonrunner_question_data_sqr() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'pythonrunner';
        $qdata->name = 'BLAH Function to square a number n';
        $qdata->questiontext = 'Write a function sqr(n) that returns n squared';
        $qdata->generalfeedback = 'No feedback available for pythonrunner questions.';
        ...
        $qdata->options->pythonrunnertype = 'python3';
     ...
     */
    public function get_pythonrunner_question_form_data_sqr() {
        $form = new stdClass();

        $form->pythonrunnertype = 'python3';
        ...
        $form->answerpreload = '';
        $form->globalextra = '';
        $form->generalfeedback = array('text' => 'No feedback available for pythonrunner questions.', 'format' => FORMAT_HTML);
     ...
     * @return stdClass the form data.
     */
    public function get_pythonrunner_question_form_data_printans() {
        $form = new stdClass();
     ...
     * @return stdClass the form data.
     */
    public function get_pythonrunner_question_form_data_python3_noace() {
        $form = get_pythonrunner_question_form_data_sqr();  // Starting point.
    ...
    /**
     * Makes a pythonrunner python3-pylint-func question asking for a sqr() function
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqr_pylint() {
        return $this->make_pythonrunner_question_sqr_subtype('python3_pylint');
    }

    /**
     *  Make a generic Python3 question  (should print "Success!")
     */
    public function make_pythonrunner_question_generic_python3() {
        return $this->make_pythonrunner_question(
                'python3',
                'GenericName',
                'Generic question',
                array(
     ...
     */
    public function make_pythonrunner_question_generic_c() {
        return $this->make_pythonrunner_question(
                'C_program',
                'GenericName',
                'Generic question',
    ...
    /**
     * Makes a pythonrunner question asking for a sqr() function.
     * @param $pythonrunnertype  The type of pythonrunner function to generate,
     * e.g. 'python3_pylint'.
     * @return qtype_pythonrunner_question
     */
    private function make_pythonrunner_question_sqr_subtype($pythonrunnertype, $extras = array()) {
        $pythonrunner = $this->make_pythonrunner_question(
                $pythonrunnertype,
     ...
     */
    public function make_pythonrunner_question_sqrnoprint() {
        $pythonrunner = $this->make_pythonrunner_question(
                'python3',
                'Function to square a number n',
                'Write a function sqr(n) that returns n squared',
    ...
    public function make_pythonrunner_question_sqr_customised() {
        $q = $this->make_pythonrunner_question_sqr_subtype('python3',
          array(
    ...
    public function make_pythonrunner_question_sqr_part_marks() {
    ...
    /**
     * Makes a pythonrunner question to write a function that just print 'Hello <name>'
     * This test also tests multiline expressions.
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_hello_func() {
        $pythonrunner = $this->make_pythonrunner_question(
                'python3',
    ...
    /**
     * Makes a pythonrunner question to write a function that reads n lines of stdin
     * and writes them to stdout.
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_copy_stdin() {
        $pythonrunner = $this->make_pythonrunner_question(
                'python3',
    ...
    /**
     * Makes a pythonrunner question that loops forever, to test sandbox timeout.
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_timeout() {
        $pythonrunner = $this->make_pythonrunner_question(
                'python3',
    ...
    /**
     * Makes a pythonrunner question that's just designed to show if the
     * __student_answer__ variable is correctly set within each test case.
     */
    public function make_pythonrunner_question_studentanswervar() {
        $pythonrunner = $this->make_pythonrunner_question(
                'python3',
                'Function to generate a timeout',
                'Write a bit of code',
    ...
    /**
     * Makes a pythonrunner question that requires students to write a function
     * that conditionally throws exceptions
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_exceptions() {
        $pythonrunner = $this->make_pythonrunner_question(
                'python3',
  ...
  try:
    ...
    /**
     * Makes a pythonrunner question to write a Python3 program that just print 'Hello Python'
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_hello_python() {
        $pythonrunner = $this->make_pythonrunner_question(
                'python3',
    ...
    /**
     * Makes a pythonrunner question that is just to demonstrate the
     * web service (so the actual question is irrelevant - only the
     * description matters).
     */
    public function get_pythonrunner_question_form_data_demows() {
        $form = new stdClass();
...
<script>
    ...
    button.onclick = function() {
        require(['core/ajax'], function(ajax) {
            ajax.call([{
                methodname: 'qtype_pythonrunner_run_in_sandbox',
                args: {
...
QEND
    ...
    /**
     * Makes a pythonrunner question of type 'sqr_user_prototype_child' to check out
     * inheritance. The prototype (sqr_user_prototype) must have been created
     * before this method can be called.
     */
    public function make_pythonrunner_question_sqr_user_prototype_child() {
        $pythonrunner = $this->make_pythonrunner_question(
                'sqr_user_prototype',
     ...
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqr_c() {
        $pythonrunner = $this->make_pythonrunner_question(
                'c_function',
                'Function to square a number n',
     ...
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqr_c_single_test() {
        $pythonrunner = $this->make_pythonrunner_question(
                'c_function',
                'Function to square a number n',
                'Write a function int sqr(int n) that returns n squared.',
    ...
    /**
     * Makes a pythonrunner question asking for a sqr() function but without
     * semicolons on the ends of all the printf testcases.
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqr_no_semicolons() {
        $pythonrunner = $this->make_pythonrunner_question(
                'c_function',
                'Function to square a number n',
                'Write a function int sqr(int n) that returns n squared.',
    ...
    /**
     * Makes a pythonrunner question to write a function that just print 'Hello ENCE260'
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_hello_prog_c() {
        $pythonrunner = $this->make_pythonrunner_question(
                'c_program',
    ...
    /**
     * Makes a pythonrunner question to write a program that reads n lines of stdin
     * and writes them to stdout.
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_copy_stdin_c() {
        $pythonrunner = $this->make_pythonrunner_question(
                'c_program',
                'Function to copy n lines of stdin to stdout',
    ...
    public function make_pythonrunner_question_str_to_upper() {
        $pythonrunner = $this->make_pythonrunner_question(
                'c_function',
...
",
    ...
    /**
     * Makes a pythonrunner question asking for a string_delete() function that
     * deletes from a given string all characters present in another
     * string.
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_string_delete() {
        $pythonrunner = $this->make_pythonrunner_question(
                'c_function',
    ...
    /**
     * Makes a pythonrunner C++ question asking for a sqr() function.
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqr_cpp() {
        $pythonrunner = $this->make_pythonrunner_question(
                'cpp_function',
                'Function to square a number n',
                'Write a function int sqr(int n) that returns n squared.',
    ...
    /**
     * Makes a pythonrunner question to write a program that just print 'Hello ENCE260'
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_hello_prog_cpp() {
        $pythonrunner = $this->make_pythonrunner_question(
                'cpp_program',
                'Program to print "Hello ENCE260"',
                'Write a program that prints "Hello ENCE260"',
    ...
    /**
     * Makes a C++ pythonrunner question to write a program that reads n lines of stdin
     * and writes them to stdout.
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_copy_stdin_cpp() {
        $pythonrunner = $this->make_pythonrunner_question(
                'cpp_program',
    ...
    public function make_pythonrunner_question_str_to_upper_cpp() {
        $pythonrunner = $this->make_pythonrunner_question(
                'cpp_function',
                'Function to convert string to uppercase',
...
",
     ...
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqrmatlab() {
        $pythonrunner = $this->make_pythonrunner_question(
            'matlab_function',
            'Function to square a number n',
            'Write a function sqr(n) that returns n squared.',
    ...
    /**
     * Makes a pythonrunner question designed to check if the MATLAB_ESCAPED_STUDENT_ANSWER
     * variable is working and usable within Matlab/Octave
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_teststudentanswermacro() {
...
EOT
     ...
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqroctave() {
        $pythonrunner = $this->make_pythonrunner_question(
            'octave_function',
            'Function to square a number n',
            'Write a function sqr(n) that returns n squared.',
     ...
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqrnodejs() {
        $pythonrunner = $this->make_pythonrunner_question(
            'nodejs',
            'Function to square a number n',
    ...
    public function make_pythonrunner_question_teststudentanswermacrooctave() {
    ...
    /**
     * Makes a pythonrunner question asking for a sqr() method in Java
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqrjava() {
        $pythonrunner = $this->make_pythonrunner_question(
                'java_method',
    ...
    /**
     * Makes a pythonrunner question asking for a Java 'Name' class
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_nameclass() {
        $pythonrunner = $this->make_pythonrunner_question(
                'java_class',
                'Name class',
    ...
    /**
     * Makes a pythonrunner question asking for a program that prints squares
     * of numbers from 1 up to and including a value read from stdin.
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_printsquares() {
        $pythonrunner = $this->make_pythonrunner_question(
                'java_program',
                'Name class',
     ...
     */
    public function make_pythonrunner_question_multilang_echo_stdin() {
        return $this->make_pythonrunner_question(
                'multilanguage',
                'Multilang Echo',
    ...
    /**
     * Makes a pythonrunner question in which the testcode is just a Java literal
     ...
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_printstr() {
        $code = <<<EOTEST
a0
b\t
c\f
...
EOPROG;
        $q = $this->make_pythonrunner_question(
                'java_program',
                'Print string',
    ...
    /**
     * Makes a pythonrunner question asking for a sqr() function in Php
     * @return qtype_pythonrunner_question
     */
    public function make_pythonrunner_question_sqrphp() {
        $pythonrunner = $this->make_pythonrunner_question(
                'php',
                'Function to square a number n',
                'Write a function sqr($n) that returns $n squared.',
    ...
    private function get_options(&$question) {
        ...
        $questiontype = new qtype_pythonrunner();
        if (!$row = $DB->get_record_select(
                   'question_python_options',
                   "pythonrunnertype = '$type' and prototypetype != 0")) {
               $error = "TestHelper: failed to load type info for question with type $type";
               throw new qtype_pythonrunner_missing_question_type($error);
        }
    ...
    // pythonrunnertestcase::make_question (q.v.).
    private function make_pythonrunner_question($type, $name, $questiontext,
            $testcases, $otheroptions = array()) {
        question_bank::load_question_definition_classes('pythonrunner');
        $pythonrunner = new qtype_pythonrunner_question();
        test_question_maker::initialise_a_question($pythonrunner);
        $pythonrunner->qtype = question_bank::get_qtype('pythonrunner');
        $pythonrunner->pythonrunnertype = $type;
        $pythonrunner->templateparams = '';
        $pythonrunner->templateparamslang = 'twig';
        $pythonrunner->templateparamsevald = null;
        $pythonrunner->uiparameters = null;
        $pythonrunner->hoisttemplateparams = 0;
        $pythonrunner->twigall = 0;
        $pythonrunner->prototypetype = 0;
        $pythonrunner->name = $name;
        $pythonrunner->precheck = 0;
        $pythonrunner->hidecheck = 0;
        $pythonrunner->questiontext = $questiontext;
        $pythonrunner->displayfeedback = 1;
        $pythonrunner->giveupallowed = 0;
        $pythonrunner->answer = '';
        $pythonrunner->answerpreload = '';
        $pythonrunner->globalextra = '';
        $pythonrunner->student = '';  // Would normally be filled in by question->start_attempt.
        $pythonrunner->generalfeedback = 'No feedback available for pythonrunner questions.';
        $pythonrunner->penaltyregime = '10, 20, ...';
        $pythonrunner->testcases = self::make_test_cases($testcases);
        $pythonrunner->options = array();
        $pythonrunner->isnew = true;  // Extra field normally added by save_question.
        $pythonrunner->context = context_system::instance(); // Use system context for testing.
        $pythonrunner->attachments = 0;
        $pythonrunner->attachmentsrequired = 0;
        $pythonrunner->maxfilesize = 0;
        $pythonrunner->filenamesregex = '';
        $pythonrunner->filenamesexplain = '';
        $pythonrunner->prototypeextra = '';
        $pythonrunner->parameters = array();  // Normally generated during question initialisation.
        foreach ($otheroptions as $key => $value) {
            $pythonrunner->$key = $value;
            $pythonrunner->options[$key] = $value;
        }
        ...
        $pythonrunnertype = new qtype_pythonrunner();
        $pythonrunnertype->clean_question_form($pythonrunner, true);
        $this->get_options($pythonrunner);
        $pythonrunner->get_prototype();
        if ($pythonrunner->prototype === null) {
            debugging("No prototype found in make_pythonrunner_question");
        }
        return $pythonrunner;
    }
}
