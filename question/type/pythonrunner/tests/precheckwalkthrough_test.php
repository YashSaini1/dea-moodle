...
class qtype_pythonrunner_precheckwalkthrough_testcase extends qbehaviour_walkthrough_test_base {
...
EOTEMPLATE;
    ...
    public function test_precheck_examples() {
        ...
        $this->check_output_contains('<div class="pythonrunner-test-results bad precheck">');
        ...
        $this->check_output_does_not_contain('print(sqr(-7))');
        $this->check_output_does_not_contain('print(sqr(-5))');
        $this->check_output_contains('<div class="pythonrunner-test-results good precheck">');
        $this->check_output_does_not_contain('Marks for this submission');
        $this->check_current_mark(null);
        $this->assertEquals('Precheck results', $qa->get_state_string(true));
        $this->save_quba();
        ...
        $this->check_output_contains('<div class="pythonrunner-test-results bad">');
        ...
        $this->check_output_contains('print(sqr(-7))');
        $this->check_output_contains('print(sqr(-5))');
        $this->check_output_contains('<div class="pythonrunner-test-results good">');
        $this->check_output_does_not_contain('Testing was aborted due to error');
