...
/**
 * Unit tests for pythonrunner's ideone sandbox class.
...
class qtype_pythonrunner_ideonesandbox_testcase extends qtype_pythonrunner_testcase {

    public function test_testfunction() {
        $this->check_sandbox_enabled('ideonesandbox');
        $sandbox = new qtype_pythonrunner_ideonesandbox();  // Lots happens here!

        $tr = $sandbox->test_function();  // Make sure the generic test runs.
        $this->assertEquals(qtype_pythonrunner_sandbox::OK, $tr->error);
    ...
    public function test_ideonesandbox_python2_good() {
        ...
        $sandbox = new qtype_pythonrunner_ideonesandbox();
