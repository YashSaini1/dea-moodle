...
$PAGE->set_url('/question/type/pythonrunner/downloadquizattempts.php');
$PAGE->set_context($context);
$PAGE->set_title(pythonrunner_str('downloadquizattempts'));
...
// Start display.
echo $OUTPUT->header();
echo $OUTPUT->heading(pythonrunner_str('downloadquizattempts'));
echo html_writer::tag('p', pythonrunner_str('downloadquizattemptshelp'));
...
foreach ($courses as $course) {
    ...
    if (!empty($quizzes)) {
        ...
        foreach ($quizzes as $quiz) {
            ...
            $csvurl = new moodle_url('/question/type/pythonrunner/getallattempts.php',
                    array('quizid' => $quiz->id, 'format' => 'csv'));
            $excelurl = new moodle_url('/question/type/pythonrunner/getallattempts.php',
                    array('quizid' => $quiz->id, 'format' => 'excel'));
            $odsurl = new moodle_url('/question/type/pythonrunner/getallattempts.php',
