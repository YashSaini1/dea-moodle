...
/**
 * List of Web Services for the qtype_sqlrunner plugin.
 *
 * @package    qtype
...
$functions = array(
    'qtype_sqlrunner_run_in_sandbox' => [
        'classname'   => 'qtype_sqlrunner\external\run_in_sandbox',
        'classpath'   => '',
        ...
        'capabilities' => 'qtype/sqlrunner:sandboxwsaccess',
