...
/**
 * Capability definitions for the qtype_sqlrunner plugin.
 *
...
$capabilities = [
    ...
    'qtype/sqlrunner:viewhiddentestcases' => [
        'riskbitmask' => 0,
        'captype' => 'read',
    ...
    'qtype/sqlrunner:sandboxwsaccess' => [
    ...
    'qtype/sqlrunner:manage_datasets' => [
        'riskbitmask'  => 0,
        'captype'      => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes'   => [
