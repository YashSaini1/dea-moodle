...
/**
 * Script to return the spec for the currently-rendered sqlrunner question,
 ...
 * although in fact it searches all zip files in the current sqlrunner
...
$qids = $USER->sqlrunnerquestionids;
