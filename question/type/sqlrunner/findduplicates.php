...
$PAGE->set_url('/question/type/sqlrunner/findduplicates.php', array('contextid' => $context->id));
...
$allquestionsmap = $bulktester->get_all_sqlrunner_questions_in_context($contextid);
