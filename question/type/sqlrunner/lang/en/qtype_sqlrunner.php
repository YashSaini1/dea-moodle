...
/**
 * Strings for component 'qtype_sqlrunner', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['addingsqlrunner'] = 'Adding a new sqlrunner Question';
...
$string['autotagbycategorytitle'] = 'SqlRunner autotag by category';
$string['autotagbycategoryindextitle'] = 'SqlRunner question autotagger';
...
$string['bulktestindextitle'] = 'SqlRunner bulk testing';
...
$string['sqlrunnercategories'] = 'Categories with SqlRunner questions';
$string['sqlrunnercontexts'] = 'Contexts with SqlRunner questions';
$string['sqlrunner'] = 'Program Code';

$string['sqlrunner_install_testsuite_title'] = 'A test suite for SqlRunner sample answers';
$string['sqlrunner_install_testsuite_title_desc'] = 'The <a href="{$a->link}">sample-answer-test script</a> verifies that the questions with sample answers are performing correctly.';
$string['sqlrunner_install_testsuite_intro'] = 'This page allows you to test that the SqlRunner questions with sample answers are functioning correctly.';
$string['sqlrunner_install_testsuite_failures'] = 'Tests that failed';
$string['sqlrunner_install_testsuite_noanswer'] = 'Questions without sample answers';

$string['sqlrunner:sandboxwsaccess'] = 'Allow access to the Jobe sandbox via web services';
$string['sqlrunner:viewhiddentestcases'] = 'See hidden testcases when reviewing questions';
$string['sqlrunner_help'] = 'In response to a question, which is a specification for a program fragment, function or whole program, the respondent enters source code in a specified computer language that satisfies the specification.';
$string['sqlrunner_link'] = 'question/type/sqlrunner';
$string['sqlrunner_question_type'] = 'SqlRunner question type: ';
$string['sqlrunnersettings'] = 'SqlRunner settings';
$string['sqlrunnersummary'] = 'Answer is program code that is executed in the context of a set of test cases to determine its correctness.';
$string['sqlrunnertype'] = 'Question type';
$string['sqlrunnertype_help'] = 'Select the programming language and question type. Once a type has been selected, details can be seen in the Question type details panel below.';
$string['sqlrunnerwssettings'] = 'Sandbox web-service settings';
...
$string['editingsqlrunner'] = 'Editing a SqlRunner Question';
...
$string['sqlequalitygrader'] = 'Sql data match';
...
$string['event_sandboxwebserviceexec_desc'] = 'A job was executed via the SqlRunner sandbox web service.';
...
$string['exportthisquestion_help'] = 'This will create a Moodle XML export file containing just this one question. One example of when this is useful if you think this question demonstrates a bug in SqlRunner that you would like to report to the developers.';
...
$string['graphui_helpmenutext_descr'] = 'Text which if non-empty replaces the standard help menu text defined in the SqlRunner language strings';
...
$string['jobe_warning_html'] = "<p style='background-color:yellow'>Run using the University of Canterbury's Jobe server. This is for initial testing only. Please set up your own Jobe server as soon as possible. See <a href='https://github.com/trampgeek/moodle-qtype_sqlrunner/blob/master/Readme.md#sandbox-configuration' target='_blank'>here</a>.</p>";
...
Site administration > Plugins > Question types > SqlRunner.
...
$string['pass'] = 'Pass';
$string['pluginname'] = 'SqlRunner';
$string['pluginnameadding'] = 'Adding a SqlRunner question';
$string['pluginnameediting'] = 'Editing a SqlRunner question';
$string['pluginnamesummary'] = 'SqlRunner: runs student-submitted code in a sandbox';
...
$string['pluginname_link'] = 'question/type/sqlrunner';
...
$string['privacy:metadata'] = 'The SqlRunner question type plugin does not store any personal data.';
...
$string['prototypeusage'] = 'SqlRunner question prototype usage for course {$a}';
...
runnable program, which is run as-is, without modification by SqlRunner,
...
resolved by writing a combinator-style question type. See the SqlRunner
...
$string['qtype_pascal_function'] = '<p>A Pascal question type where the student
 ...
 the student answer followed by the SqlRunner <i>testcode</i> wrapped
...
forces SqlRunner into a fallback mode of running each test case separately.</p>';
...
$string['qWrongBehaviour'] = 'Please use Adaptive Behaviour for all SqlRunner questions, or there can be massive performance hits. For example, all questions on a page will need to be regraded when the page is re-displayed.';

$string['regexgrader'] = 'Regular expression';
$string['replacedollarscount'] = 'This category contains {$a} SqlRunner questions.';
...
$string['resultstring-internalerror'] = 'SqlRunner error (IE): please tell a tutor';
$string['resultstring-sandboxpending'] = 'SqlRunner error (PD): please tell a tutor';
$string['resultstring-sandboxpolicy'] = 'SqlRunner error (BP): please tell a tutor';
...
$string['run_code_failed'] = 'Failed to run code';
...
$string['type_header'] = 'SqlRunner question type';
...
main SqlRunner documentation at https://github.com/trampgeek/moodle-qtype_sqlrunner#code-runner.
...
$string['unauthorisedbulktest'] = 'You do not have suitable access to any SqlRunner questions';
...
$string['xmlsqlrunnerformaterror'] = 'XML format error in sqlrunner question';
$string['answer'] = 'Answer';
$string['empty_set'] = 'Empty set';
$string['filename'] = 'Filename';
$string['tables'] = 'Tables';

$string['sqlrunner:manage_datasets'] = 'Edit question datasets';
$string['manage_datasets'] = 'Manage datasets';
$string['add_dataset'] = 'Add dataset';
$string['add_datasets'] = 'Add datasets';
$string['edit_dataset'] = 'Edit dataset';
$string['dataset_updated'] = 'Dataset successfully updated';
$string['dataset_created'] = 'Successfully created {$a} records';
$string['form_dataset_name'] = 'Dataset {no}';
$string['form_dataset_tables_name'] = 'Tables for dataset {no}';
$string['form_dataset'] = 'Dataset field';
$string['form_dataset_help'] = "This is a dataset field. You need to upload .sql file here, which contains the necessary tables (table creation and its filling).\nKeep in mind, that datasets will be processed one by one from lower index to higher. If one dataset file uses tables from another dataset file, you must first upload the referenced file and after uload file that have the reference.";
$string['form_dataset_tables'] = 'Dataset tables field';
$string['form_dataset_tables_help'] = 'This is a dataset tables field. You need to input here ALL tables, created by uploaded dataset file divided by ",".';

$string['dataset_can_force_delete'] = 'You can force delete this dataset';

$string['exception_invalid_dataset_id'] = 'Invalid dataset id';
$string['exception_cannot_delete_file'] = 'Cannot delete dataset file tables: "{$a->error}". {$a->link}';
$string['exception_cannot_create_or_update_dataset'] = 'Cannot create or update dataset';
$string['exception_failed_create_files_tables'] = 'Failed to create files tables';
$string['exception_sql_file_run_failed'] = 'File {$a->filename} trigger an error: "{$a->error}". Rollback all changes (make sure that mysql cannot rollback table creation. Please use "DROP TABLE IF EXISTS" in the first line of dataset).';
$string['exception_cannot_start_transaction'] = 'Cannot start transaction';

$string['error_existed_table'] = 'This tables already exists in another datasets: {$a}';
$string['error_duplicated_tables'] = 'Duplicated tables in uploaded files: {$a}';
$string['error_missed_file_tables'] = 'Inputted tables missed in uploaded files: {$a}';
$string['error_missed_inputted_tables'] = 'No inputted tables in uploaded files: {$a}';
$string['error_wrong_database_connection_parameters'] = 'Wrong database connection parameters';

$string['error:database_timeout'] = 'Failed to run code due to un-optimal query. Please make sure your code doesn’t run for more than {$a->timeout} seconds or returns a large number of rows. We recommend using limit statements and avoiding cross joins.';

$string['question_completed'] = 'Question passed!';
$string['question_not_completed'] = 'Wrong answer!';

$string['select_category'] = 'Select a category';
$string['not_selected'] = 'Not selected';

$string['exception_emptycategory'] = 'You not create the question category';

$string['dbhost'] = 'Database host with questions dataset';
$string['dbport'] = '(optional) if empty, port will be 3306';
$string['dbname'] = 'Questions database name';
$string['dbuser'] = 'Questions database user (needs to run student code)';
$string['dbpass'] = 'Questions database pass (needs to run student code)';
$string['dbrootuser'] = 'Questions database root user (needs to upload datasets)';
$string['dbrootpass'] = 'Questions database root pass (needs to upload dataset)';