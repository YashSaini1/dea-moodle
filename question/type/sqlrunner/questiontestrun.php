...
// Initialise $PAGE.
$PAGE->set_url('/question/type/sqlrunner/questiontestrun.php', $urlparams);
$title = sqlrunner_str('testingquestion', format_string($question->name));
...
$exportquestionlink = new moodle_url('/question/type/sqlrunner/exportone.php', $urlparams);
$exportquestionlink->param('sesskey', sesskey());

// Create the question usage we will use.

$quba = question_engine::make_questions_usage_by_activity('qtype_sqlrunner', $context);
...
if ($canedit) {
    echo html_writer::tag('p',
            html_writer::link($exportquestionlink, sqlrunner_str('exportthisquestion')) .
            $OUTPUT->help_icon('exportthisquestion', 'qtype_sqlrunner'));
}
