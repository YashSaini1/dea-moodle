 ...
 *
 * @module qtype_sqlrunner/ui_table
...
define(['jquery'], function($) {
    ...
    TableUi.prototype.reload = function() {
        var
            ...
            preload = [],
            divHtml = "<div style='height:fit-content' class='qtype-sqlrunner-table-outer-div'>\n" +
                      "<table class='table table-bordered qtype-sqlrunner_table'>\n";
