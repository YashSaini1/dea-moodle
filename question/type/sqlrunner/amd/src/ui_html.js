 ...
 * of all author-supplied HTML elements with a class 'sqlrunner-ui-element';
 ...
 * div.qtype-sqlrunner-html-outer-div. The author-supplied HTML must include
...
define(['jquery'], function($) {
    ...
    HtmlUi.prototype.getFields = function() {
        return $(this.htmlDiv).find('.sqlrunner-ui-element');
    };
    ...
    HtmlUi.prototype.reload = function() {
        var
            ...
            fields,
            leftOvers,
            outerDivId = 'qtype-sqlrunner-outer-div-' + this.textareaId.toString(),
            outerDiv = "<div style='height:fit-content' class='qtype-sqlrunner-html-outer-div' id='" + outerDivId + "'>";
