 ...
 *
 * @module qtype_sqlrunner/ui_gapfiller
...
define(['jquery'], function($) {
    ...
    GapfillerUi.prototype.markUp = function(tagContents) {
         ...
         */
        function input(size) {
            return '<input name="cr_gapfiller_field" class="sqlrunner-ui-element" size="' + size + '">';
        }
        ...
        function textarea(rows, cols) {
            return '<textarea name="cr_gapfiller_field" class ="sqlrunner-ui-element" ' +
    ...
    GapfillerUi.prototype.reload = function() {
        var
            ...
            i,
            fields,
            outerDiv = "<div style='height:fit-content' class='qtype-sqlrunner-html-outer-div'>";
