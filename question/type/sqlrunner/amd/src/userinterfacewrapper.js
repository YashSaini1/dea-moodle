 ...
 * wrapper.
 *
 * @module sqlrunner/userinterfacewrapper
...
define(['jquery', 'qtype_sqlrunner/ace/ace'], function($) {
    ...
    InterfaceWrapper.prototype.loadUi = function(uiname, params) {
        var t = this,
            ...
            errPart2 = ' UI component. If this error persists, please report it to the forum on sqlrunner.org.nz';
        ...
        function setLoadFailMessage(langString, errorDiv) {
            require(['core/str'], function(str) {
                 ...
                 */
                var
                    s = str.get_string(langString, 'qtype_sqlrunner'),
                    fallback = str.get_string('ui_fallback', 'qtype_sqlrunner');
