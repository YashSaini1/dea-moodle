 ...
 *
 * @module qtype_sqlrunner/showdiff
...
define(['jquery'], function($) {
    ...
    /**
     * Now the API for applying diffs to rows in a sqlrunner
     * results table. Defines a class with methods initDiffButton and
     * processAllRows.
     * @param {array} tableRows The list of rows from the sqlrunner results table.
    ...
    function initDiffButton(buttonId, showValue, hideValue, expectedString, gotString) {
        ...
        table = diffButton.closest('div.sqlrunner-test-results');
