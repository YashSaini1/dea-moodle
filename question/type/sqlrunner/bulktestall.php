...
$PAGE->set_url('/question/type/sqlrunner/bulktestall.php',
        array('startfromcontextid' => $startfromcontextid));
$PAGE->set_context($context);
$title = sqlrunner_str('bulktesttitle', $context->get_context_name());
...
// Run the tests.
foreach ($bulktester->get_num_sqlrunner_questions_by_context() as $contextid => $numsqlrunnerquestions) {
    ...
    if (has_capability('moodle/question:editall', $context)) {
        echo $OUTPUT->heading(sqlrunner_str('bulktesttitle', $testcontext->get_context_name()));
        echo html_writer::tag('p', html_writer::link(
                new moodle_url('/question/type/sqlrunner/bulktestall.php',
                    array('startfromcontextid' => $testcontext->id)),
            sqlrunner_str('bulktestcontinuefromhere')));
