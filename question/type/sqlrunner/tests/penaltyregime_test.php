...
require_once($CFG->dirroot . '/question/type/sqlrunner/tests/helper.php');
...
class qtype_sqlrunner_penaltyregime_testcase extends qbehaviour_walkthrough_test_base {
    ...
    public function run_with_regime($regime, $numbadattempts, $expected) {
        $helper = new qtype_sqlrunner_test_helper();
        $q = $helper->make_sqlrunner_question_sqr(array('penaltyregime' => $regime));
