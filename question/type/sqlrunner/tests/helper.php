<?php
// This file is part of CodeRunner - http://sqlrunner.org.nz/
//
...
/**
 * Test helpers for the sqlrunner question type.
 *
 * @package    qtype
...
require_once($CFG->dirroot . '/question/type/sqlrunner/tests/test.php');

qtype_sqlrunner_testcase::setup_test_sandbox_configuration();
...
class qtype_sqlrunner_missing_question_type extends Exception {
}

/**
 * Test helper class for the sqlrunner question type.
 *
 */
class qtype_sqlrunner_test_helper extends question_test_helper {
    ...
    /**
     * Makes a sqlrunner python3 question asking for a sqr() function
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqr($extras = array()) {
        return $this->make_sqlrunner_question_sqr_subtype('python3', $extras);
    }

    public function get_sqlrunner_question_data_sqr() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'sqlrunner';
        $qdata->name = 'BLAH Function to square a number n';
        $qdata->questiontext = 'Write a function sqr(n) that returns n squared';
        $qdata->generalfeedback = 'No feedback available for sqlrunner questions.';
        ...
        $qdata->options->sqlrunnertype = 'python3';
     ...
     */
    public function get_sqlrunner_question_form_data_sqr() {
        $form = new stdClass();

        $form->sqlrunnertype = 'python3';
        $form->showsource = 0;
        ...
        $form->answerpreload = '';
        $form->globalextra = '';
        $form->generalfeedback = array('text' => 'No feedback available for sqlrunner questions.', 'format' => FORMAT_HTML);
     ...
     * @return stdClass the form data.
     */
    public function get_sqlrunner_question_form_data_printans() {
        $form = new stdClass();
     ...
     * @return stdClass the form data.
     */
    public function get_sqlrunner_question_form_data_python3_noace() {
        $form = get_sqlrunner_question_form_data_sqr();  // Starting point.
    ...
    /**
     * Makes a sqlrunner python3-pylint-func question asking for a sqr() function
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqr_pylint() {
        return $this->make_sqlrunner_question_sqr_subtype('python3_pylint');
    }

    /**
     *  Make a generic Python3 question  (should print "Success!")
     */
    public function make_sqlrunner_question_generic_python3() {
        return $this->make_sqlrunner_question(
                'python3',
                'GenericName',
                'Generic question',
                array(
     ...
     */
    public function make_sqlrunner_question_generic_c() {
        return $this->make_sqlrunner_question(
                'C_program',
                'GenericName',
                'Generic question',
    ...
    /**
     * Makes a sqlrunner question asking for a sqr() function.
     * @param $sqlrunnertype  The type of sqlrunner function to generate,
     * e.g. 'python3_pylint'.
     * @return qtype_sqlrunner_question
     */
    private function make_sqlrunner_question_sqr_subtype($sqlrunnertype, $extras = array()) {
        $sqlrunner = $this->make_sqlrunner_question(
                $sqlrunnertype,
     ...
     */
    public function make_sqlrunner_question_sqrnoprint() {
        $sqlrunner = $this->make_sqlrunner_question(
                'python3',
                'Function to square a number n',
                'Write a function sqr(n) that returns n squared',
    ...
    public function make_sqlrunner_question_sqr_customised() {
        $q = $this->make_sqlrunner_question_sqr_subtype('python3',
          array(
    ...
    public function make_sqlrunner_question_sqr_part_marks() {
    ...
    /**
     * Makes a sqlrunner question to write a function that just print 'Hello <name>'
     * This test also tests multiline expressions.
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_hello_func() {
        $sqlrunner = $this->make_sqlrunner_question(
                'python3',
    ...
    /**
     * Makes a sqlrunner question to write a function that reads n lines of stdin
     * and writes them to stdout.
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_copy_stdin() {
        $sqlrunner = $this->make_sqlrunner_question(
                'python3',
    ...
    /**
     * Makes a sqlrunner question that loops forever, to test sandbox timeout.
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_timeout() {
        $sqlrunner = $this->make_sqlrunner_question(
                'python3',
    ...
    /**
     * Makes a sqlrunner question that's just designed to show if the
     * __student_answer__ variable is correctly set within each test case.
     */
    public function make_sqlrunner_question_studentanswervar() {
        $sqlrunner = $this->make_sqlrunner_question(
                'python3',
                'Function to generate a timeout',
                'Write a bit of code',
    ...
    /**
     * Makes a sqlrunner question that requires students to write a function
     * that conditionally throws exceptions
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_exceptions() {
        $sqlrunner = $this->make_sqlrunner_question(
                'python3',
  ...
  try:
    ...
    /**
     * Makes a sqlrunner question to write a Python3 program that just print 'Hello Python'
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_hello_python() {
        $sqlrunner = $this->make_sqlrunner_question(
                'python3',
    ...
    /**
     * Makes a sqlrunner question that is just to demonstrate the
     * web service (so the actual question is irrelevant - only the
     * description matters).
     */
    public function get_sqlrunner_question_form_data_demows() {
        $form = new stdClass();
...
<script>
    ...
    button.onclick = function() {
        require(['core/ajax'], function(ajax) {
            ajax.call([{
                methodname: 'qtype_sqlrunner_run_in_sandbox',
                args: {
...
QEND
    ...
    /**
     * Makes a sqlrunner question of type 'sqr_user_prototype_child' to check out
     * inheritance. The prototype (sqr_user_prototype) must have been created
     * before this method can be called.
     */
    public function make_sqlrunner_question_sqr_user_prototype_child() {
        $sqlrunner = $this->make_sqlrunner_question(
                'sqr_user_prototype',
     ...
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqr_c() {
        $sqlrunner = $this->make_sqlrunner_question(
                'c_function',
                'Function to square a number n',
     ...
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqr_c_single_test() {
        $sqlrunner = $this->make_sqlrunner_question(
                'c_function',
                'Function to square a number n',
                'Write a function int sqr(int n) that returns n squared.',
    ...
    /**
     * Makes a sqlrunner question asking for a sqr() function but without
     * semicolons on the ends of all the printf testcases.
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqr_no_semicolons() {
        $sqlrunner = $this->make_sqlrunner_question(
                'c_function',
                'Function to square a number n',
                'Write a function int sqr(int n) that returns n squared.',
    ...
    /**
     * Makes a sqlrunner question to write a function that just print 'Hello ENCE260'
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_hello_prog_c() {
        $sqlrunner = $this->make_sqlrunner_question(
                'c_program',
    ...
    /**
     * Makes a sqlrunner question to write a program that reads n lines of stdin
     * and writes them to stdout.
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_copy_stdin_c() {
        $sqlrunner = $this->make_sqlrunner_question(
                'c_program',
                'Function to copy n lines of stdin to stdout',
    ...
    public function make_sqlrunner_question_str_to_upper() {
        $sqlrunner = $this->make_sqlrunner_question(
                'c_function',
...
",
    ...
    /**
     * Makes a sqlrunner question asking for a string_delete() function that
     * deletes from a given string all characters present in another
     * string.
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_string_delete() {
        $sqlrunner = $this->make_sqlrunner_question(
                'c_function',
    ...
    /**
     * Makes a sqlrunner C++ question asking for a sqr() function.
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqr_cpp() {
        $sqlrunner = $this->make_sqlrunner_question(
                'cpp_function',
                'Function to square a number n',
                'Write a function int sqr(int n) that returns n squared.',
    ...
    /**
     * Makes a sqlrunner question to write a program that just print 'Hello ENCE260'
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_hello_prog_cpp() {
        $sqlrunner = $this->make_sqlrunner_question(
                'cpp_program',
                'Program to print "Hello ENCE260"',
                'Write a program that prints "Hello ENCE260"',
    ...
    /**
     * Makes a C++ sqlrunner question to write a program that reads n lines of stdin
     * and writes them to stdout.
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_copy_stdin_cpp() {
        $sqlrunner = $this->make_sqlrunner_question(
                'cpp_program',
    ...
    public function make_sqlrunner_question_str_to_upper_cpp() {
        $sqlrunner = $this->make_sqlrunner_question(
                'cpp_function',
                'Function to convert string to uppercase',
...
",
     ...
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqrmatlab() {
        $sqlrunner = $this->make_sqlrunner_question(
            'matlab_function',
            'Function to square a number n',
            'Write a function sqr(n) that returns n squared.',
    ...
    /**
     * Makes a sqlrunner question designed to check if the MATLAB_ESCAPED_STUDENT_ANSWER
     * variable is working and usable within Matlab/Octave
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_teststudentanswermacro() {
...
EOT
     ...
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqroctave() {
        $sqlrunner = $this->make_sqlrunner_question(
            'octave_function',
            'Function to square a number n',
            'Write a function sqr(n) that returns n squared.',
     ...
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqrnodejs() {
        $sqlrunner = $this->make_sqlrunner_question(
            'nodejs',
            'Function to square a number n',
    ...
    public function make_sqlrunner_question_teststudentanswermacrooctave() {
    ...
    /**
     * Makes a sqlrunner question asking for a sqr() method in Java
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqrjava() {
        $sqlrunner = $this->make_sqlrunner_question(
                'java_method',
    ...
    /**
     * Makes a sqlrunner question asking for a Java 'Name' class
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_nameclass() {
        $sqlrunner = $this->make_sqlrunner_question(
                'java_class',
                'Name class',
    ...
    /**
     * Makes a sqlrunner question asking for a program that prints squares
     * of numbers from 1 up to and including a value read from stdin.
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_printsquares() {
        $sqlrunner = $this->make_sqlrunner_question(
                'java_program',
                'Name class',
     ...
     */
    public function make_sqlrunner_question_multilang_echo_stdin() {
        return $this->make_sqlrunner_question(
                'multilanguage',
                'Multilang Echo',
    ...
    /**
     * Makes a sqlrunner question in which the testcode is just a Java literal
     ...
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_printstr() {
        $code = <<<EOTEST
a0
b\t
c\f
...
EOPROG;
        $q = $this->make_sqlrunner_question(
                'java_program',
                'Print string',
    ...
    /**
     * Makes a sqlrunner question asking for a sqr() function in Php
     * @return qtype_sqlrunner_question
     */
    public function make_sqlrunner_question_sqrphp() {
        $sqlrunner = $this->make_sqlrunner_question(
                'php',
                'Function to square a number n',
                'Write a function sqr($n) that returns $n squared.',
    ...
    private function get_options(&$question) {
        ...
        $type = $question->sqlrunnertype;
        $questiontype = new qtype_sqlrunner();
        if (!$row = $DB->get_record_select(
                   'question_sqlrunner_options',
                   "sqlrunnertype = '$type' and prototypetype != 0")) {
               $error = "TestHelper: failed to load type info for question with type $type";
               throw new qtype_sqlrunner_missing_question_type($error);
        }
    ...
    // sqlrunnertestcase::make_question (q.v.).
    private function make_sqlrunner_question($type, $name, $questiontext,
            $testcases, $otheroptions = array()) {
        question_bank::load_question_definition_classes('sqlrunner');
        $sqlrunner = new qtype_sqlrunner_question();
        test_question_maker::initialise_a_question($sqlrunner);
        $sqlrunner->qtype = question_bank::get_qtype('sqlrunner');
        $sqlrunner->sqlrunnertype = $type;
        $sqlrunner->templateparams = '';
        $sqlrunner->templateparamslang = 'twig';
        $sqlrunner->templateparamsevalpertry = 0;
        $sqlrunner->templateparamsevald = null;
        $sqlrunner->uiparameters = null;
        $sqlrunner->hoisttemplateparams = 0;
        $sqlrunner->twigall = 0;
        $sqlrunner->prototypetype = 0;
        $sqlrunner->name = $name;
        $sqlrunner->precheck = 0;
        $sqlrunner->hidecheck = 0;
        $sqlrunner->questiontext = $questiontext;
        $sqlrunner->displayfeedback = 1;
        $sqlrunner->giveupallowed = 0;
        $sqlrunner->answer = '';
        $sqlrunner->answerpreload = '';
        $sqlrunner->globalextra = '';
        $sqlrunner->allornothing = true;
        $sqlrunner->student = '';  // Would normally be filled in by question->start_attempt.
        $sqlrunner->showsource = false;
        $sqlrunner->generalfeedback = 'No feedback available for sqlrunner questions.';
        $sqlrunner->penaltyregime = '10, 20, ...';
        $sqlrunner->testcases = self::make_test_cases($testcases);
        $sqlrunner->options = array();
        $sqlrunner->isnew = true;  // Extra field normally added by save_question.
        $sqlrunner->context = context_system::instance(); // Use system context for testing.
        $sqlrunner->attachments = 0;
        $sqlrunner->attachmentsrequired = 0;
        $sqlrunner->maxfilesize = 0;
        $sqlrunner->filenamesregex = '';
        $sqlrunner->filenamesexplain = '';
        $sqlrunner->prototypeextra = '';
        $sqlrunner->parameters = array();  // Normally generated during question initialisation.
        foreach ($otheroptions as $key => $value) {
            $sqlrunner->$key = $value;
            $sqlrunner->options[$key] = $value;
        }
        ...
        $sqlrunnertype = new qtype_sqlrunner();
        $sqlrunnertype->clean_question_form($sqlrunner, true);
        $this->get_options($sqlrunner);
        $sqlrunner->get_prototype();
        if ($sqlrunner->prototype === null) {
            debugging("No prototype found in make_sqlrunner_question");
        }
        return $sqlrunner;
    }
}
