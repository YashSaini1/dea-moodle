...
/**
 * Unit tests for the sqlrunner question prototype capability
...
class qtype_sqlrunner_prototype_testcase extends qtype_sqlrunner_testcase {
...
EOTEMPLATE;
  ...
  <question type="sqlrunner">
    ...
    <generalfeedback format="html">
      <text>No feedback available for sqlrunner questions.</text>
    </generalfeedback>
    <defaultgrade>1</defaultgrade>
    <penalty>0.3333333</penalty>
    <hidden>0</hidden>
    <idnumber></idnumber>
    <sqlrunnertype>sqr_user_prototype</sqlrunnertype>
...
';
    ...
    private function make_sqr_user_type_prototype($fileattachmentreqd = false) {
        ...
        $q->prototypetype = 2;
        $q->sqlrunnertype = "sqr_user_prototype";
        ...
        $row = new qtype_sqlrunner_question();
