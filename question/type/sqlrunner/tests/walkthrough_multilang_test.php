...
class qtype_sqlrunner_walkthrough_multilang_testcase extends qbehaviour_walkthrough_test_base {
...
public class InOut {
    public static void main(String[] args) throws IOException {
        ...
        $q = test_question_maker::make_question('sqlrunner', 'multilang_echo_stdin');
