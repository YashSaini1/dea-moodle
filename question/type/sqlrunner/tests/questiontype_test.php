...
/**
 * Unit tests for the sqlrunner question type class.
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_sqlrunner_questiontype_testcase extends advanced_testcase {
    protected $qtype;
    ...
    public function test_name() {
        $this->assertEquals('sqlrunner', $this->qtype->name());
    }
