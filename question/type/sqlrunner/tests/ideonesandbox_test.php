...
/**
 * Unit tests for sqlrunner's ideone sandbox class.
...
class qtype_sqlrunner_ideonesandbox_testcase extends qtype_sqlrunner_testcase {

    public function test_testfunction() {
        $this->check_sandbox_enabled('ideonesandbox');
        $sandbox = new qtype_sqlrunner_ideonesandbox();  // Lots happens here!

        $tr = $sandbox->test_function();  // Make sure the generic test runs.
        $this->assertEquals(qtype_sqlrunner_sandbox::OK, $tr->error);
    ...
    public function test_ideonesandbox_python2_good() {
        ...
        $sandbox = new qtype_sqlrunner_ideonesandbox();
