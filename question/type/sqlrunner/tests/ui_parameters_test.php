 ...
 */
class qtype_sqlrunner_ui_parameters_testcase extends qtype_sqlrunner_testcase {

    // Test that the json specifier for the graph_ui class can be loaded.
    public function test_params() {
        $graphuiparams = new qtype_sqlrunner_ui_parameters('graph');
        ...
        $aceparams = new qtype_sqlrunner_ui_parameters('ace');
