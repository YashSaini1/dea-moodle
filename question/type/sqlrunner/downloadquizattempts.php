...
$PAGE->set_url('/question/type/sqlrunner/downloadquizattempts.php');
$PAGE->set_context($context);
$PAGE->set_title(sqlrunner_str('downloadquizattempts'));
...
// Start display.
echo $OUTPUT->header();
echo $OUTPUT->heading(sqlrunner_str('downloadquizattempts'));
echo html_writer::tag('p', sqlrunner_str('downloadquizattemptshelp'));
...
foreach ($courses as $course) {
    ...
    if (!empty($quizzes)) {
        ...
        foreach ($quizzes as $quiz) {
            ...
            $csvurl = new moodle_url('/question/type/sqlrunner/getallattempts.php',
                    array('quizid' => $quiz->id, 'format' => 'csv'));
            $excelurl = new moodle_url('/question/type/sqlrunner/getallattempts.php',
                    array('quizid' => $quiz->id, 'format' => 'excel'));
            $odsurl = new moodle_url('/question/type/sqlrunner/getallattempts.php',
