...
global $CFG;
require_once $CFG->dirroot . '/question/type/sqlrunner/classes/twigmacros.php';


// Class that provides a singleton instance of the twig environment.
class qtype_sqlrunner_twig {
    protected static $twigenvironments = array(true => null, false => null);
    ...
    protected static function get_twig_environment($isstrict=false, $isdebug=false) {
        if (self::$twigenvironments[$isstrict] === null) {
            ...
            $macros = qtype_sqlrunner_twigmacros::macros();
            ...
            $newrandom = new \Twig\TwigFunction('random', 'qtype_sqlrunner_twig_random',
                array('needs_environment' => true));
            $setrandomseed = new \Twig\TwigFunction('set_random_seed', 'qtype_sqlrunner_set_random_seed',
                array('needs_environment' => true));
            $twig->addFunction($newrandom);
            $twig->addFunction($setrandomseed);
            $shuffle = new \Twig\TwigFilter('shuffle', 'qtype_sqlrunner_twig_shuffle',
                array('needs_environment' => true));
    ...
    public static function render($s, $student, $parameters=array(), $isstrict=false) {
        $twig = qtype_sqlrunner_twig::get_twig_environment($isstrict);
 ...
 */
function qtype_sqlrunner_twig_random(Twig\Environment $env, $values = null, $max = null)
{
    if (null === $values) {
 ...
 */
function qtype_sqlrunner_set_random_seed(Twig\Environment $env, $seed)
{
    mt_srand($seed);
    return '';
}
 ...
 */
function qtype_sqlrunner_twig_shuffle(Twig\Environment $env, $array) {
    shuffle($array);
    return $array;
}
