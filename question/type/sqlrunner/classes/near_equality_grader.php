...
class qtype_sqlrunner_near_equality_grader extends qtype_sqlrunner_grader {
    ...
    protected function grade_known_good(&$output, &$testcase) {
        ...
        $cleanedexpected = qtype_sqlrunner_util::clean($testcase->expected);
    ...
    // to lower case.
    protected function reduce(&$output) {
