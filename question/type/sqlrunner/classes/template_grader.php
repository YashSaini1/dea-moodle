...
/** The qtype_sqlrunner_per_test_template_grader class.
...
class qtype_sqlrunner_template_grader extends qtype_sqlrunner_grader {
    ...
    protected function grade_known_good(&$output, &$testcase) {
        ...
        if ($result === null || !isset($result->fraction) || !is_numeric($result->fraction)) {
            ...
            $errormessage = sqlrunner_str($errorcode, array('output' => $output));
