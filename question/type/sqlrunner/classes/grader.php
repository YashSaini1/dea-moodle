...
/** The base class for the sqlrunner Grader classes.
 ...
 *  In the simplest subclass, qtype_sqlrunner_equality_grader, a test result is correct if
...
abstract class qtype_sqlrunner_grader {
    ...
    public static function available_graders() {
        return array(
            ...
            'NearEqualityGrader' => 'qtype_sqlrunner_near_equality_grader',
            'RegexGrader'        => 'qtype_sqlrunner_regex_grader',
            'TemplateGrader'     => 'qtype_sqlrunner_template_grader',
        );
    }
    ...
    public function grade(&$output, &$testcase, $isbad = false) {
        if ($isbad) {
            $outcome = new qtype_sqlrunner_test_result($testcase, false, 0.0, $output);
        } else {
