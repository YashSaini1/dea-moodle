...
$THEME->layouts = [
    ...
    // SQL editor page.
    // Note, that moodle cannot create a block, if page contain '_' or '-' symbols in a middle of pagetype
    // Because clean_param() func cut '_' or '-' symbols
    'questioneditor' => array(
        'file' => 'question_editor.php',
...
$THEME->scss = function($theme) {
  return theme_sql_get_main_scss_content($theme);
};

$THEME->haseditswitch = true;
$THEME->extrascsscallback = 'theme_sql_get_extra_scss';
